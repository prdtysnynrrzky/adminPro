                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-header pb-3 d-flex align-items-center justify-content-between">
                            ...
                            <span type="button" class="btn btn-primary btn-sm bg-gradient-primary ml-auto"
                                data-bs-toggle="modal" data-bs-target="#modalTambah">tambah</span>
                        </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="align-middle text-center text-xs d-flex gap-2">
                                                        <button type="button" class="btn btn-warning btn-sm bg-gradient-warning"
                                                            ...
                                                            data-bs-target="#modalEdit<?= $row->id_kategori ?>">Edit</button>
                                                        <a href="#" class="btn btn-danger"
                                                            onclick="confirmDelete(<?= $row->id_kategori ?>)">Hapus</a>
                                                    </td>
                                                </tr>
                                                <?php
                                            }
