                            ...
                            <a href="profile/index.php" class="nav-link text-body font-weight-bold px-0">
                                ...
                                if (mysqli_num_rows($sqlUser) > 0) {
                                    while ($row = mysqli_fetch_object($sqlUser)) {
                                        ...
                                        <img src="profile/img/<?= $row->image ?>" alt="avatar" class="rounded-circle" width="30"
                                            height="30">
                                    <?php }
                                }
                                ?>
                                ...
                                <div class="col-8">
                                    <div class="numbers">
                                        ...
                                        <h5 class="font-weight-bolder mb-0">
                                            <?php
                                            $queryProduk = "SELECT COUNT(*) AS total_produk FROM produk";
                                            $resultProduk = mysqli_query($conn, $queryProduk);

                                            if ($resultProduk) {
                                                $row = mysqli_fetch_assoc($resultProduk);
                                                echo $row['total_produk'];
                                            } else {
                                                echo "Gagal mengambil total kategori";
                                            }
                                            ?>
                                        </h5>
                                    </div>
                                ...
                                <div class="col-8">
                                    <div class="numbers">
                                        ...
                                        <h5 class="font-weight-bolder mb-0">
                                            ...
                                            if ($resultKategori) {
                                                $row = mysqli_fetch_assoc($resultKategori);
                                ...
                                <div class="col-8">
                                    <div class="numbers">
                                        ...
                                        <h5 class="font-weight-bolder mb-0">
                                            ...
                                            if ($resultPenjualan) {
                                                $row = mysqli_fetch_assoc($resultPenjualan);
                                                echo $row['total_penjualan'];
                                            } else {
                                                echo "Gagal mengambil total penjualan";
                                            }
                                            ?>
                                        </h5>
                                    </div>
                            ...
                            <div class="timeline timeline-one-side">
                                <div class="timeline-block mb-3">
                                    ...
                                    <div class="timeline-content">
                                        <h6 class="text-dark text-sm font-weight-bold mb-0">Login Admin</h6>
                                        <p class="text-secondary font-weight-bold text-xs mt-1 mb-0">Admin masuk ke
                                            dalam sistem dengan username dan password.</p>
                                    </div>
                                </div>
                                <div class="timeline-block mb-3">
                                    <span class="timeline-step">
                                    ...
                                    <div class="timeline-content">
                                        <h6 class="text-dark text-sm font-weight-bold mb-0">Dashboard Admin</h6>
                                        <p class="text-secondary font-weight-bold text-xs mt-1 mb-0">Setelah login,
                                            admin akan diarahkan ke dashboard utama. Dashboard menampilkan ringkasan
                                            statistik, seperti jumlah produk, total penjualan, dll.</p>
                                    </div>
                                </div>
                                <div class="timeline-block mb-3">
                                    <span class="timeline-step">
                                        <i class="ni ni-basket text-warning text-gradient"></i>
                                    </span>
                                    <div class="timeline-content">
                                        <h6 class="text-dark text-sm font-weight-bold mb-0">Kelola Produk</h6>
                                        <p class="text-secondary font-weight-bold text-xs mt-1 mb-0">Admin dapat
                                            menambahkan, mengedit, atau menghapus produk. Informasi produk mencakup
                                            nama, deskripsi, harga, dan stok.</p>
                                    </div>
                                </div>
                                <div class="timeline-block mb-3">
                                    <span class="timeline-step">
                                        <i class="ni ni-archive-2 text-primary text-gradient"></i>
                                    </span>
                                    <div class="timeline-content">
                                        <h6 class="text-dark text-sm font-weight-bold mb-0">Kelola Kategori</h6>
                                        <p class="text-secondary font-weight-bold text-xs mt-1 mb-0">Admin dapat membuat
                                            dan mengatur kategori produk untuk mengorganisir produk sesuai jenisnya.</p>
                                    </div>
                                </div>
                                <div class="timeline-block">
                                    <span class="timeline-step">
                                        <i class="ni ni-chart-pie-35 text-danger text-gradient"></i>
                                    </span>
                                    <div class="timeline-content">
