                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-header pb-3 d-flex align-items-center justify-content-between">
                            <h6>Tabel Produk</h6>
                            <?php
                            $sqlTotalKategori = "SELECT COUNT(*) AS total FROM kategori";
                            $resultTotalKategori = $conn->query($sqlTotalKategori);

                            if ($resultTotalKategori->num_rows > 0) {
                                $rowTotalKategori = $resultTotalKategori->fetch_assoc();
                                $total_kategori = $rowTotalKategori["total"];
                            } else {
                                $total_kategori = 0;
                            }
                            ?>
                            <button type="button" class="btn btn-primary btn-sm bg-gradient-primary ml-auto"
                                data-bs-toggle="modal" data-bs-target="#modalTambah" <?php if ($total_kategori == 0)
                                    echo "disabled"; ?>>
                                Tambah
                            </button>
                        </div>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="d-flex px-2 py-1">
                                                                    <div>
                                                                        <img src="img/<?= $row->image ?>" class="avatar avatar-sm me-3"
                                                                            alt="user1">
                                                                    </div>
                                                            ...
                                                            <td class="align-middle text-center text-xs d-flex gap-2">
                                                                <button type="button" class="btn btn-warning btn-sm bg-gradient-warning"
                                                                    data-bs-toggle="modal"
                                                                    data-bs-target="#modalEdit<?= $row->id_produk ?>">Edit</button>
                                                                <a href="#" class="btn btn-danger"
                                                                    onclick="confirmDelete(<?= $row->id_produk ?>)">Hapus</a>
                                                            </td>
                                                            </td>
                                                        </tr>
                                                        <?php
